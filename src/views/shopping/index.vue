      ...
      >
        <div class="adv-left">
          <div class="fs-30 color-000 flex-center">
            ...
            >
              {{ item.atlas && item.atlas.category }}
            </span>
          ...
          <div class="fs-24 color-333 mt-10 text-el" style="width: 4.9rem">
            {{ item.atlas && item.atlas.desc }}
          </div>
          <div class="mt-24">
            <span class="coin fs-28">收藏量{{ item.atlas && item.atlas.like_count }}</span>
            <span class="qty fs-20 ml-24">
              曝光量{{ item.atlas && item.atlas.favorite_count }}
            </span>
          </div>
        </div>
        <div class="adv-right">
          ...
          <div class="dist fs-20" v-if="item.distance">
            {{ item.atlas && item.atlas.sender.username }}
          </div>
        </div>
      </div>
    </van-list>
